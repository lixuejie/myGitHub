...
public final class HelloServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.hnair.hello.Hello.HelloRequest,
      com.hnair.hello.Hello.HelloResponse> METHOD_SAY_HELLO =
      io.grpc.MethodDescriptor.<com.hnair.hello.Hello.HelloRequest, com.hnair.hello.Hello.HelloResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "HelloService", "sayHello"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.hnair.hello.Hello.HelloRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.hnair.hello.Hello.HelloResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.hnair.hello.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hnair.hello.Hello.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.hnair.hello.Hello.HelloRequest,
                com.hnair.hello.Hello.HelloResponse>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.hnair.hello.Hello.HelloResponse sayHello(com.hnair.hello.Hello.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hnair.hello.Hello.HelloResponse> sayHello(
        com.hnair.hello.Hello.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.hnair.hello.Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.hnair.hello.Hello.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static final class HelloServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.hnair.hello.Hello.getDescriptor();
    }
  }
